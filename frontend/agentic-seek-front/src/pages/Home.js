...
function Home() {
    ...
    const saveToHistory = (message) => {
        try {
            ...
            localStorage.setItem('agenticSeekHistory', JSON.stringify(trimmedHistory));
        } catch (err) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const errorMessage = { type: 'error', content: 'Error: Unable to get a response.', timestamp: new Date().toISOString() };
